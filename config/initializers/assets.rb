...
Rails.application.config.assets.precompile += %w( francis.css )
...
Rails.application.config.assets.precompile += %w( footer.css )
Rails.application.config.assets.precompile += %w( rails_bootstrap_forms.css )
Rails.application.config.assets.precompile += %w( navigation.js )
Rails.application.config.assets.precompile += %w( subletinn.css )
Rails.application.config.assets.precompile += %w( locations.css )
Rails.application.config.assets.precompile += %w( contact.css )
Rails.application.config.assets.precompile += %w( houses.css )
